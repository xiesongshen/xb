...
CREATE TABLE `meeting`  (
  ...
  `status` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '会议状态 0:未开始 1:进行中 2:已结束',
...
INSERT INTO `meeting` VALUES (40, NULL, 1, 'hello', '电话iOS符号', '2020-07-01 19:20:49', '2020-07-01 23:20:00', '2020-07-02 19:20:00', '2', NULL);
...
CREATE TABLE `menu`  (
  ...
  `p_id` int(5) NULL DEFAULT NULL,
  `type` int(5) NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `order_by` int(5) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `menu` VALUES (3, 1, 2, '用户管理', '/user/list', 1);
INSERT INTO `menu` VALUES (4, 1, 2, '部门管理', '/dept/list', 3);
INSERT INTO `menu` VALUES (5, 2, 2, '角色管理', NULL, 1);
INSERT INTO `menu` VALUES (6, 1, 2, '会议管理', '/meeting/list', 3);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, NULL, '51575eb8de0a2a8ee6b01d59ba151e61', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2019-12-01 10:51:50', '2020-01-03 00:00:00', 'http://localhost:8080/upload/def.png', 48, NULL, '', NULL);
INSERT INTO `user` VALUES (2, 'xiaodong', 'admin', 'xiaobiao@dfbz.com', NULL, NULL, '小东', 18, '110', '1', '我很帅啊', '2019-12-02 12:35:10', '2019-11-20 10:51:53', 'http://localhost:8080/upload/def.png', 32, '1', '研发部', 10);
...
INSERT INTO `user` VALUES (24, 'xiesongs', '22', '22', NULL, NULL, '22', 22, '22', '0', '22', '2020-06-24 12:01:24', NULL, NULL, NULL, NULL, NULL, 8);
INSERT INTO `user` VALUES (25, 'cjj', 'a906449d5769fa7361d7ecc6aa3f6d28', '1692495161@qq.com', NULL, NULL, '11', 18, '11', '1', '11', '2020-06-28 10:57:06', NULL, '1593596913921.jpg', NULL, NULL, NULL, 1);
INSERT INTO `user` VALUES (27, 'Xsss', 'a906449d5769fa7361d7ecc6aa3f6d28', '11', NULL, NULL, '11', 18, '11', NULL, '111', '2020-06-28 14:14:35', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES (33, 'Xss', 'a906449d5769fa7361d7ecc6aa3f6d28', '1692495161@qq.com', NULL, NULL, '11', 18, '11', '1', '111', '2020-06-29 13:27:58', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES (52, '1593517880800', 'a906449d5769fa7361d7ecc6aa3f6d28', NULL, NULL, 'oQ4QeuJP922L0ZG3SQU4KdiwsxHQ', '奇奇怪怪', NULL, NULL, '1', NULL, '2020-06-30 19:51:20', NULL, 'http://thirdwx.qlogo.cn/mmopen/vi_32/RzArIGhcmhEyKHybatWmLmdrP67ia1GaqnXgGDl1e5WUHh0UGRP2mZCOKnsPN860bRmS53U2kh3QLdSKx6BsiaEg/132', NULL, NULL, NULL, NULL);
